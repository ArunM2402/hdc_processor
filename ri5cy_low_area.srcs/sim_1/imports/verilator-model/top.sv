...
hdc_unit(
    .clk                    (clk_i), 
    .reset                  (!rstn_i),
    .from_decoder_start     (HD_computing_o),
    .predicted_class        (hdc_predicted_class),
    .SC_done                (SC_done)
    );
